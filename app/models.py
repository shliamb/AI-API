...
class UsersBase(Base):
    ...
    username = Column(sqlalchemy.String(50), nullable=True) # Username пользователя, для идентификации в API
    appkey = Column(UUID(as_uuid=True), default=uuid.uuid4, nullable=False) # Автоматически создается UUID в качестве API Key
    ...
    #"9a5bce5f-4462-4d12-a66c-d59584b19ee8",
